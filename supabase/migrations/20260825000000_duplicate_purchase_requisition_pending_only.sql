-- Duplicate previously worked from any status; now restricted to
-- pending_rfq only, matching delete_purchase_requisition's existing
-- "only pending_rfq" restriction and this repo's established
-- "wrong status for this mutation" convention (errcode 55000).
