...
const t = en.staff.requestedQuote.pager;

const PAGE_SIZE_OPTIONS = [10, 20, 50];

export type RfqPagerProps = {
  page: number;
  pageSize: number;
  total: number;
...
export function RfqPager({ page, pageSize, total, onPageChange, onPageSizeChange }: RfqPagerProps) {
